...
│
└───────𖦹Ꜥꜥ`
let buttons = [{ buttonId: 'allmenu', buttonText: { displayText: '»Semua Menu«' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '👑Sewa' }, type: 1 }]
...
╰───────────❏`
            ...
            let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '»Semua Menu«' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: '»Peraturan«' }, type: 1 },{ buttonId: 'buysc', buttonText: { displayText: '»Script Bot«' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '»Donasi«' }, type: 1 }]
